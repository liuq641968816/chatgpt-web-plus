...
docker build --platform linux/amd64 -t registry.cn-hangzhou.aliyuncs.com/brongrass/chatgpt-plus-web:$version-$arch -f dockerfile-vue ../

if [ "$3" = "push" ];then
  docker push registry.cn-hangzhou.aliyuncs.com/brongrass/chatgpt-plus-api:$version-$arch
  docker push registry.cn-hangzhou.aliyuncs.com/brongrass/chatgpt-plus-web:$version-$arch
fi
